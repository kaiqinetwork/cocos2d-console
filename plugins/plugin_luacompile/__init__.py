...
class CCPluginLuaCompile(cocos.CCPlugin):
    ...
    def get_luajit_path(self):
        ...
        if cocos.os_is_win32():
            ret = os.path.join(self._workingdir, "bin", luajit_dir, "luajit-win32.exe")
        elif cocos.os_is_mac():
            ret = os.path.join(self._workingdir, "bin", luajit_dir, "luajit-mac")
        elif cocos.os_is_linux():
            ret = os.path.join(self._workingdir, "bin", luajit_dir, "luajit-linux")
